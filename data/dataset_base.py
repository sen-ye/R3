                ...
                for group_index, group_iter in enumerate(self.dataset_iters):
                    if self.is_mandatory[group_index]:
                        while True:
                            ...
                            num_tokens = sample['num_tokens'] + 2 * len(sample['sequence_plan']) # we need 2 * len(sequence_plan) for special tokens
    ...
    def pack_sequence(self, sample, sequence_status):
        ...
        for item in sequence_plan:
            ...
            if item['type'] == 'text':
                ...
                if item.get('add_end_answer', False):
                    text_ids.append(self.answer_end)
                ...
                # This is used for maze edit dataset when reach the goal
